      ...
      <div className="max-w-4xl mx-auto space-y-6 pb-12">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-800">Create New Template</h1>
              <p className="text-sm text-slate-500 mt-0.5">Build a reusable layout with custom HTML markup.</p>
            </div>
          </div>
        </div>
        ...
        {successMsg && (
          <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded-xl flex items-center gap-2 text-sm">
            ...
            <span>Template created successfully! Redirecting to templates list...</span>
          </div>
        )}
